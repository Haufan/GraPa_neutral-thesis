    ...
    window.Sentiment = {
        ...
        add_node: function (node_id, x, y, label, type) {
            ...
            if ($('#' + node_id).length == 0) {
                ...
                else if (type == 'node_type_neutral_thesis')
                    new_node.addClass("node_type_neutral_thesis");
...
jQuery('<div/>', {
    class: 'rmenu_element',
    id: 'add_neutral_thesis',
    text: 'add neutral thesis'
}).appendTo('#rmenu');
...
//	    };
        ...
        _get_arg_semantic_type_of_element: function (e) {
            ...
            else if (e.classList.contains('node_type_neutral_thesis')) return "ADU";
            else return "unknown";
        },
...
// Special-case: ADU (proponent/opponent) -> neutral thesis => auto 'support'
if ((i.connection.source.classList.contains('node_type_proponent') || i.connection.source.classList.contains('node_type_opponent')) &&
    i.connection.target.classList.contains('node_type_neutral_thesis')) {
    window.Sentiment.labelPopUpButton_click(null, null, null, null, null, null, null, 'support');
    return;
}
